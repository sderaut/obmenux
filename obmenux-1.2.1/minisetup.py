...
'''minisetup.py component of obmenux installer
 this is for a minimal setup, excluding the pipe menu scripts,
 for use with `install` option, to install obmenux minimal, e.g.
 `sudo python2 minisetup.py install`
 
 typical effect:
     writes script to  /usr/local/bin
